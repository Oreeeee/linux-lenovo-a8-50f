...
kal_int32 fgauge_get_Q_max_high_current(kal_int16 temperature)
{
    ...
    if (temperature <= TEMPERATURE_T1)
    {
        ...
        if (g_fg_battery_id == 1)
        {
        	low_Q_max = Q_MAX_NEG_10_H_CURRENT_LGC;
        }
        else
        {
        ...
        if (g_fg_battery_id == 1)
        {
        	high_Q_max = Q_MAX_POS_0_H_CURRENT_LGC;
        }
        else
        {
    ...
    else if (temperature <= TEMPERATURE_T2)
    {
        ...
        if (g_fg_battery_id == 1)
        {
        	low_Q_max = Q_MAX_POS_0_H_CURRENT_LGC;
        }
        else
        {
        ...
        if (g_fg_battery_id == 1)
        {
        	high_Q_max = Q_MAX_POS_25_H_CURRENT_LGC;
        }
        else
        {
    ...
    else
    {
        ...
        if (g_fg_battery_id == 1)
        {
        	low_Q_max = Q_MAX_POS_25_H_CURRENT_LGC;
        }
        else
        {
        ...
        if (g_fg_battery_id == 1)
        {
        	high_Q_max = Q_MAX_POS_50_H_CURRENT_LGC;
        }
        else
        {
...
BATTERY_PROFILE_STRUC_P fgauge_get_profile(kal_uint32 temperature)
{
    switch (temperature)
    {
        case TEMPERATURE_T0:
            if (g_fg_battery_id == 1)
            {
            	return &battery_profile_t0_lgc[0];
            }
            else
            {
        ...
        case TEMPERATURE_T1:
            if (g_fg_battery_id == 1)
            {
            	return &battery_profile_t1_lgc[0];
            }
            else
            {
        ...
        case TEMPERATURE_T2:
            if (g_fg_battery_id == 1)
            {
            	return &battery_profile_t2_lgc[0];
            }
            else
            {
        ...
        case TEMPERATURE_T3:
            if (g_fg_battery_id == 1)
            {
            	return &battery_profile_t3_lgc[0];
            }
            else
            {
