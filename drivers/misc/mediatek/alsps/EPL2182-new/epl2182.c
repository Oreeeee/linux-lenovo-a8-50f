...
#if DYN_ENABLE
#define DYN_H_OFFSET 	 	400//600
#define DYN_L_OFFSET		150//400
...
static int elan_epl2182_psensor_enable(struct epl2182_priv *epl_data, int enable)
{
    ...
    if(enable)
    {
 	...
 	regdata = EPL_SENSING_2_TIME | EPL_PS_MODE | EPL_M_GAIN ;//2015-03-04
        ...
        regdata = PS_INTT<<4 | EPL_PST_1_TIME | EPL_12BIT_ADC; //2015-03-04
        ret = elan_epl2182_I2C_Write(client,REG_1,W_SINGLE_BYTE,0X02,regdata);
#if ELAN_WRITE_CALI
...
#else
    if((enable_ps&& obj->hw->polling_mode_ps == 1) || (enable_als==true  && enable_hs==false) || (enable_als==true && enable_ps==true) || (enable_als==true && enable_ps==false) || DYN_ENABLE)
#endif
#endif
    {
